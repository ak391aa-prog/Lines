...
export const allMockVideos: Video[] = [
  ...mockVideos,
...
export const mockChannels: FollowedChannel[] = [
    { name: 'CodeMasters', handle: '@codemasters', subscriberCount: 1250000, avatarUrl: 'https://picsum.photos/seed/ch2/48/48' },
    { name: 'Nature Explorers', handle: '@natureexplorers', subscriberCount: 2300000, avatarUrl: 'https://picsum.photos/seed/ch1/48/48' },
    { name: 'FutureVisions', handle: '@futurevisions', subscriberCount: 4100000, avatarUrl: 'https://picsum.photos/seed/ch4/48/48' },
    { name: 'DesignScapes', handle: '@designscapes', subscriberCount: 780000, avatarUrl: 'https://picsum.photos/seed/ch3/48/48' },
    { name: 'Gourmet Chef', handle: '@gourmetchef', subscriberCount: 950000, avatarUrl: 'https://picsum.photos/seed/ch5/48/48', isLive: true },
    { name: '3DArts', handle: '@3darts', subscriberCount: 450000, avatarUrl: 'https://picsum.photos/seed/ch6/48/48' },
    { name: 'ZenLife', handle: '@zenlife', subscriberCount: 620000, avatarUrl: 'https://picsum.photos/seed/ch7/48/48' },
    { name: 'TechExplained', handle: '@techexplained', subscriberCount: 3100000, avatarUrl: 'https://picsum.photos/seed/ch8/48/48' },
];

export const CATEGORIES = ['All', 'Trending', 'Gaming', 'Music', 'Coding', 'Design', 'Travel', 'Cooking', 'Health', 'Technology'];